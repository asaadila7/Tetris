...
public class Menu extends Container implements ActionListener {
    ...
    //Buttons
    private JButton instructions = new JButton (new ImageIcon (this.getClass ().getResource ("Resources/Instructions.png"))); //instructions button
    private JButton settings = new JButton (new ImageIcon (this.getClass ().getResource ("Resources/settings.png"))); // settings button
