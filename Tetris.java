...
public class Tetris extends Container {
    ...
    private final ImageIcon empty = new ImageIcon (new File ("./SmallerTiles/empty.png").getPath ()); //empty spaces
    ...
    public Tetris () {
        ...
        JButton pause = new JButton (new ImageIcon (new File ("./pause.png").getPath ()));
        ...
        //initialize tiles
        for (int i = 0; i < 7; i++) {
            tiles [i] = new ImageIcon (new File ("./SmallerTiles/" + colours [i] + ".png").getPath ());
        }

        for (int i = 0; i < 7; i++) {
            ghostTiles [i] = new ImageIcon (new File ("./SmallerTiles/empty" + colours [i] + ".png").getPath ());
        }
